  <%@ Page Language="C#" AutoEventWireup="true" CodeFile="Login.aspx.cs"  EnableEventValidation="false" Inherits="sitemaster_Login" %>
...
<meta name="viewport" content="width=device-width, initial-scale=1">
    ...
    <!-- Custom Theme files -->
    <link href="../LoginTemp/css/bootstrap.css" type="text/css" rel="stylesheet" media="all">
    <link href="../LoginTemp/css/style.css" type="text/css" rel="stylesheet" media="all">
    <!-- color switch -->
    <link href="../LoginTemp/css/blast.min.css" rel="stylesheet" />
    <!-- lightbox -->
    <link rel="stylesheet" href="../LoginTemp/css/lightbox.min.css">
    <!-- portfolio -->
    <link rel="stylesheet" href="../LoginTemp/css/portfolio.css">
    <!-- font-awesome icons -->
    <link href="../LoginTemp/css/font-awesome.min.css" rel="stylesheet">
    <!-- //Custom Theme files -->
    <!-- online-fonts -->
...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
       ...
       <nav class="navbar fixed-top navbar-expand-lg navbar-light navbar-fixed-top">
            <div class="container">
                <h1 class="wthree-logo">
                    <a href="index.html" id="logoLink" data-blast="color">
                        <h1>DE-DUPLICATION</h1></a>
                </h1>
        ...
        <div class="container-fluid">
            <div class="row banner-row">
                <div class="col-lg-8 bg-img text-center">
                    <h3 class="agile-title">Login Here..</h3>
                    <div class="bnr-img">
                        <img src="../LoginTemp/images/palette.png" alt="" class="img-fluid m-auto" />
                                ...
                                <div class="float">
                                 ...
                                 <%--   <form class="form" action="#" method="post">--%>
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="txt_username" runat="server"  name="username"  class="form-control" type="email" placeholder="Email" required=""></asp:TextBox>
                                        <%--    <input type="text" name="username" id="username" class="form-control" placeholder="your name" required>--%>
                                        </div>
                                        <div class="form-group">
                                            <label for="password">Password</label><br>
                                            <asp:TextBox ID="txt_pswd" runat="server" name="password" type="Password" class="form-control" placeholder="*****" required=""></asp:TextBox>
                                       <%--     <input type="password" name="password" id="password" class="form-control" placeholder="*****" required>--%>
                                        </div>
                                        <div class="form-group btn-agile" style="text-align: right">

                                            <asp:Button ID="Button1" runat="server" Text="Login" name="submit" class="btn btn-primary btn-md" value="login" OnClick="Button1_Click" />
            ...
            <div class="container">
                <div class="tab-content" id="pills-tabContent">
                    ...
                    <div class="tab-pane fade clearfix" id="Tab2-Image" role="tabpanel" aria-labelledby="Tab2-Image-tab">
                        <div class="portfolio">
                            <a href="../LoginTemp/images/g1.jpg" class="img-fluid" data-lightbox="example-set" data-title="Add text to your image to make a commentary for it!">
                                <img class="categoryd-img img-fluid" src="images/g1.jpg" alt="flyer-portfolio" />
                            </a>
                            <div class="desc">Tab2-Image 1</div>
                        </div>
                        <div class="portfolio">
                            <a href="../LoginTemp/images/g2.jpg" class="img-fluid" data-lightbox="example-set" data-title="Add text to your image to make a commentary for it!">
                                <img class="categoryd-img img-fluid" src="../LoginTemp/images/g2.jpg" alt="flyer-portfolio" />
                            </a>
                            <div class="desc">Tab2-Image 2</div>
                        </div>
                        <div class="portfolio">
                            <a href="../LoginTemp/images/g3.jpg" class="img-fluid" data-lightbox="example-set" data-title="Add text to your image to make a commentary for it!">
                                <img class="categoryd-img img-fluid" src="../LoginTemp/images/g3.jpg" alt="flyer-portfolio" />
                            </a>
        ...
        <div class="container py-md-5">
            ...
            <div class="d-flex team-agile-row pt-sm-5 pt-3">
                <div class="col-lg-4 col-md-6">
                    <div class="box20">
                        <img src="../LoginTemp/images/t2.jpg" alt="" class="img-fluid" />
                ...
                <div class="col-lg-4 col-md-6 mt-md-0 mt-4">
                    <div class="box20">
                        <img src="../LoginTemp/images/t1.jpg" alt="" class="img-fluid" />
                        <div class="box-content">
    ...
    <div class="container slide-wthree">
        <div class="row">
            <div class="col-lg-6 mx-auto text-center">
                ...
                <img src="../LoginTemp/images/slide.png" class="img-fluid" alt="" />
                ...
                <div class="row contact-bottom">
                    ...
                    <div class="col-md-4">
                        <div class="address mt-md-0 mt-3">
                            ...
                            <p>
                                <a href="mailto:info@example.com">mail@palette.com</a>
                            </p>
                            <p>
                                <a href="mailto:info@example.com">mail@paletteinfo.com</a>
                            </p>
                        </div>
                    </div>
                </div>
    ...
    <footer class="py-5">
        <div class="container">
            <div class="row">
                <div class="col-lg-3">
                    <h2 class="agile-title"><a href="index.html" class="text-capitalize" data-blast="color">Palette</a></h2>
                </div>
                <div class="col-lg-3  mt-lg-0 mt-4">
                    <ul class="list-agileits">
                        ...
                        <li class="my-3">
                            <a href="#about" class="scroll text-secondary">
                                About Us
                            </a>
                        </li>
                        <li>
                ...
                <div class="col-lg-3 mt-lg-0 my-4">
                    ...
                    <div class="fv3-contact my-3">
                        ...
                        <p class="text-secondary">+456 123 7890</p>
                    </div>
                </div>
                <div class="col-lg-3">
    ...
    <!-- js -->
    <script src="../LoginTemp/js/jquery-2.2.3.min.js"></script>
    <!-- //js -->
    <!--  menu toggle -->
    <script src="../LoginTemp/js/menu.js"></script>
    <!-- color switch -->
    <script src="../LoginTemp/js/blast.min.js"></script>
    <!-- light box -->
    <script src="../LoginTemp/js/lightbox-plus-jquery.min.js"></script>
    <!-- Scrolling Nav JavaScript -->
    <script src="../LoginTemp/js/scrolling-nav.js"></script>
    <!-- start-smooth-scrolling -->
    <script src="../LoginTemp/js/move-top.js"></script>
    <script src="../LoginTemp/js/easing.js"></script>
    <script>
    ...
    <script src="../LoginTemp/js/SmoothScroll.min.js"></script>
    <!-- //smooth-scrolling-of-move-up -->
    <!-- Bootstrap core JavaScript
================================================== -->
    <!-- Placed at the end of the document so the pages load faster -->
    <script src="../LoginTemp/js/bootstrap.js"></script>
</body>
