<%@ Page Title="" Language="C#" MasterPageFile="~/Jobseekers/job.master"  EnableEventValidation="false" AutoEventWireup="true" CodeFile="viewvacancy.aspx.cs" Inherits="user_viewvacancy" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <Center>
        ...
        <br />
         ...
         <strong>
        <asp:Label ID="Label6" runat="server" CssClass="auto-style6"></asp:Label>
        </strong>
                ...
                <tr>
                    <td class="text-center"><strong>Skills:
                        <asp:Label ID="Label5" runat="server" Text='<%# Eval("skills") %>'></asp:Label>
                         <br />
                        <br />
                        <asp:Button ID="Button1" runat="server" CssClass="btn btn btn-danger" CommandName="view" CommandArgument='<%# Eval("vid") %>' Text="Apply Now" />
                        <br />
                        <br />
                        </strong></td>
                </tr>
